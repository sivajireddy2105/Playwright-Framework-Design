...
```
Error: locator.selectOption: Error: strict mode violation: locator('div ul li.ng-scope') resolved to 41 elements:
    1) <li list-select="" class="ng-scope">…</li> aka getByRole('listitem').filter({ hasText: 'Arabic' })
    2) <li list-select="" class="ng-scope">…</li> aka getByRole('listitem').filter({ hasText: 'Bulgarian' })
    ...

Call log:
  - waiting for locator('div ul li.ng-scope')
...
- generic [active] [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Dynamic data testing" [ref=f1e52] [cursor=pointer]
          - link "Web application testing" [ref=f1e57] [cursor=pointer]
          - link "Software" [ref=f1e62] [cursor=pointer]
          - link "QA testing platform" [ref=f1e67] [cursor=pointer]
          - link "Computer Security" [ref=f1e72] [cursor=pointer]
          - link "Test case generation" [ref=f1e77] [cursor=pointer]
          - link "Language Resources" [ref=f1e82] [cursor=pointer]
          - link "Selenium certification program" [ref=f1e87] [cursor=pointer]
      - generic [ref=f1e93]:
        - generic [ref=f1e94]:
        ...
        - generic [ref=f1e119]:
          ...
          - generic [ref=f1e121]:
            - generic [ref=f1e122]:
              - checkbox [checked] [ref=f1e123]
              - generic [ref=f1e124]: Cricket
            - generic [ref=f1e125]:
              - checkbox [checked] [ref=f1e126]
              - generic [ref=f1e127]: Movies
            - generic [ref=f1e128]:
              - checkbox [ref=f1e129]
              - generic [ref=f1e130]: Hockey
        - generic [ref=f1e131]:
          - generic [ref=f1e132]: Languages
          - list [ref=f1e136] [cursor=pointer]:
            - listitem [ref=f1e137]: Arabic
            - listitem [ref=f1e138]: Bulgarian
            - listitem [ref=f1e139]: Catalan
            - listitem [ref=f1e140]: Croatian
            - listitem [ref=f1e141]: Czech
            - listitem [ref=f1e142]: Danish
            - listitem [ref=f1e143]: Dutch
            - listitem [ref=f1e144]: English
            - listitem [ref=f1e145]: Estonian
            - listitem [ref=f1e146]: Filipino
            - listitem [ref=f1e147]: Finnish
            - listitem [ref=f1e148]: French
            - listitem [ref=f1e149]: German
            - listitem [ref=f1e150]: Greek
            - listitem [ref=f1e151]: Hebrew
            - listitem [ref=f1e152]: Hindi
            - listitem [ref=f1e153]: Hungarian
            - listitem [ref=f1e154]: Icelandic
            - listitem [ref=f1e155]: Indonesian
            - listitem [ref=f1e156]: Italian
            - listitem [ref=f1e157]: Japanese
            - listitem [ref=f1e158]: Korean
            - listitem [ref=f1e159]: Latvian
            - listitem [ref=f1e160]: Lithuanian
            - listitem [ref=f1e161]: Malay
            - listitem [ref=f1e162]: Norwegian
            - listitem [ref=f1e163]: Persian
            - listitem [ref=f1e164]: Polish
            - listitem [ref=f1e165]: Portuguese
            - listitem [ref=f1e166]: Romanian
            - listitem [ref=f1e167]: Russian
            - listitem [ref=f1e168]: Serbian
            - listitem [ref=f1e169]: Slovak
            - listitem [ref=f1e170]: Slovenian
            - listitem [ref=f1e171]: Spanish
            - listitem [ref=f1e172]: Swedish
            - listitem [ref=f1e173]: Thai
            - listitem [ref=f1e174]: Turkish
            - listitem [ref=f1e175]: Ukrainian
            - listitem [ref=f1e176]: Urdu
            - listitem [ref=f1e177]: Vietnamese
        - generic [ref=f1e178]:
          - generic [ref=f1e179]: Skills
          - combobox [ref=f1e181]:
            ...
            - option "XHTML"
        - generic [ref=f1e182]:
          - generic [ref=f1e183]: Country*
          - combobox [ref=f1e185]:
            - option "Select Country" [selected]
        - generic [ref=f1e186]:
          - generic [ref=f1e187]: "Select Country :"
          - generic [ref=f1e188]:
            - combobox [ref=f1e189]
            - combobox [ref=f1e192] [cursor=pointer]
        - generic [ref=f1e193]:
          - generic [ref=f1e194]: Date Of Birth
          - combobox [ref=f1e196]:
          ...
          - combobox [ref=f1e200]:
            ...
            - option "31"
        - generic [ref=f1e201]:
          - generic [ref=f1e202]: Password
          - textbox [ref=f1e204]
        - generic [ref=f1e205]:
          - generic [ref=f1e206]: Confirm Password
          - textbox [ref=f1e208]
        - generic [ref=f1e209]:
          - button "Submit" [ref=f1e210] [cursor=pointer]
          - button "Refresh" [ref=f1e211] [cursor=pointer]
      - generic [ref=f1e212]:
        - generic [ref=f1e213]: Photo
        - button "Choose File" [ref=f1e217]
  - generic:
    - insertion:
      - iframe [ref=f1e219]:
  ...
  - contentinfo [ref=f1e220]:
    - generic [ref=f1e222]:
      - generic [ref=f1e223]:
        - text: "\"@ 2016\""
        - link "Automation Testing" [ref=f1e224] [cursor=pointer]:
          - /url: "#"
...
```ts
  ...
  21 |         await page.locator(`//input[@value="${hobby}"]`).check()
  22 |     }
  23 | 
  24 |     //multi-select dropdown
  25 |     await page.locator('multi-select div#msdd').click()
  26 |     const languages = await page.locator('div ul li.ng-scope')
> 27 |     await languages.selectOption({label: 'German'})
     |                     ^ Error: locator.selectOption: Error: strict mode violation: locator('div ul li.ng-scope') resolved to 41 elements:
  28 | 
  29 |     // const selectedLanguage = await page.locator('div.ui-autocomplete-multiselect-item')
  30 |     // const closeIcon = await page.locator('span.ui-icon.ui-icon-close')
  31 | 
  32 |     await page.pause()
  33 | })
```