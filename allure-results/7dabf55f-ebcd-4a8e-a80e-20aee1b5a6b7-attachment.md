...
Call log:
  - waiting for locator('//a[normalize-space()="German"]')
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "UI testing services" [ref=f1e52] [cursor=pointer]
          - link "Automation demo site" [ref=f1e57] [cursor=pointer]
          - link "Email & Messaging" [ref=f1e62] [cursor=pointer]
          - link "Test automation tools" [ref=f1e67] [cursor=pointer]
          - link "Web application testing" [ref=f1e72] [cursor=pointer]
          - link "Interaction testing tools" [ref=f1e77] [cursor=pointer]
          - link "Selenium certification program" [ref=f1e82] [cursor=pointer]
          - link "Foreign Language Resources" [ref=f1e87] [cursor=pointer]
      - generic [ref=f1e93]:
        - generic [ref=f1e94]:
...
```ts
  ...
  25 |     await page.locator('div#msdd').click({force: true})
