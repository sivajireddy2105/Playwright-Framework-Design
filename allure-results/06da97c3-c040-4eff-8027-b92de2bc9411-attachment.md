...
Call log:
  - waiting for locator('div ul li.ng-scope').locator('a:has-text("German")')
...
- generic [active] [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Automation demo site" [ref=f1e52] [cursor=pointer]
          - link "UI testing services" [ref=f1e57] [cursor=pointer]
          - link "Selenium certification program" [ref=f1e62] [cursor=pointer]
          - link "WYSIWYG editor testing" [ref=f1e67] [cursor=pointer]
          - link "Datepicker testing" [ref=f1e72] [cursor=pointer]
          - link "Drag and drop testing" [ref=f1e77] [cursor=pointer]
          - link "Selenium WebDriver training" [ref=f1e82] [cursor=pointer]
  ...
  - generic [ref=f1e194]:
    - link "Go to shopping options for WYSIWYG editor testing" [ref=f1e199] [cursor=pointer]: WYSIWYG editor testing
...
> 27 |     await languages.locator('a:has-text("German")').click()
     |                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  28 | 
