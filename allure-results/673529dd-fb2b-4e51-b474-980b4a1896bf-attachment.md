...
Call log:
  - waiting for getByRole('checkbox', { name: ' Cricket ', exact: true })
...
- generic [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Factory Automation" [ref=f1e57] [cursor=pointer]
          - link "Test case generation" [ref=f1e62] [cursor=pointer]
          - link "Drag and drop testing" [ref=f1e67] [cursor=pointer]
          - link "Southeast Asians & Pacific Islanders" [ref=f1e72] [cursor=pointer]
          - link "Automated UI validation" [ref=f1e77] [cursor=pointer]
          - link "WYSIWYG editor testing" [ref=f1e82] [cursor=pointer]
  ...
  - generic [ref=f1e194]:
    - link "Go to shopping options for Test case generation" [ref=f1e199] [cursor=pointer]: Test case generation
