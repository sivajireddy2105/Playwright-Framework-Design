...
Call log:
  - waiting for locator('div ul li.ng-scope').locator('//a[normalize-space()="German"]')
...
- generic [active] [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Social Sciences" [ref=f1e52] [cursor=pointer]
          - link "Interaction testing tools" [ref=f1e57] [cursor=pointer]
          - link "Foreign Language Resources" [ref=f1e62] [cursor=pointer]
          - link "Test automation tools" [ref=f1e67] [cursor=pointer]
          - link "Computer Security" [ref=f1e72] [cursor=pointer]
          - link "Automation demo site" [ref=f1e77] [cursor=pointer]
          - link "Software testing tutorials" [ref=f1e82] [cursor=pointer]
          - link "UI testing services" [ref=f1e87] [cursor=pointer]
      - generic [ref=f1e93]:
        - generic [ref=f1e94]:
  ...
  - generic [ref=f1e194]:
    - link "Go to shopping options for Drag and drop testing" [ref=f1e199] [cursor=pointer]: Drag and drop testing
...
> 27 |     await page.locator('//a[normalize-space()="German"]').click()
     |                                                                ^ Error: locator.click: Test timeout of 30000ms exceeded.
  28 | 
