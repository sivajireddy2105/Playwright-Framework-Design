...
```
Error: locator.check: Error: strict mode violation: getByRole('radio', { name: ' Male ' }) resolved to 2 elements:
    1) <input required="" type="radio" value="Male" name="radiooptions" ng-model="radiovalue" class="ng-pristine ng-untouched ng-invalid ng-invalid-required"/> aka getByRole('radio', { name: 'Male', exact: true })
    2) <input type="radio" value="FeMale" name="radiooptions" ng-model="radiovalue" class="ng-pristine ng-untouched ng-valid"/> aka getByRole('radio', { name: 'FeMale' })
...
- generic [ref=f1e1]:
  ...
  - generic [ref=f1e42]:
    ...
    - generic [ref=f1e44]:
      ...
      - generic [ref=f1e50]:
        - generic [ref=f1e51]:
          - generic [ref=f1e52]: Full Name*
          - textbox "First Name" [ref=f1e54]: Shivaji
          - textbox "Last Name" [ref=f1e56]: Reddy
        - generic [ref=f1e57]:
          - generic [ref=f1e58]: Address
          - textbox [ref=f1e60]: Hyderabad 500032
        - generic [ref=f1e61]:
          - generic [ref=f1e62]: Email address*
          - textbox [ref=f1e64]: test123@gmail.com
        - generic [ref=f1e65]:
          - generic [ref=f1e66]: Phone*
          - textbox [active] [ref=f1e68]: "9874563210"
        - generic [ref=f1e69]:
          - generic [ref=f1e70]: Gender*
          - generic [ref=f1e71]:
            - generic [ref=f1e72]:
              - radio "Male" [ref=f1e73]
              - text: Male
            - generic [ref=f1e74]:
              - radio "FeMale" [ref=f1e75]
              - text: FeMale
        - generic [ref=f1e76]:
          - generic [ref=f1e77]: Hobbies
          - generic [ref=f1e78]:
            - generic [ref=f1e79]:
              - checkbox [ref=f1e80]
              - generic [ref=f1e81]: Cricket
            - generic [ref=f1e82]:
              - checkbox [ref=f1e83]
              - generic [ref=f1e84]: Movies
            - generic [ref=f1e85]:
              - checkbox [ref=f1e86]
              - generic [ref=f1e87]: Hockey
        - generic [ref=f1e88]: Languages
        - generic [ref=f1e93]:
          - generic [ref=f1e94]: Skills
          - combobox [ref=f1e96]:
            ...
            - option "XHTML"
        - generic [ref=f1e97]:
          - generic [ref=f1e98]: Country*
          - combobox [ref=f1e100]:
            - option "Select Country" [selected]
        - generic [ref=f1e101]:
          - generic [ref=f1e102]: "Select Country :"
          - generic [ref=f1e103]:
            - combobox [ref=f1e104]
            - combobox [ref=f1e107] [cursor=pointer]
        - generic [ref=f1e108]:
          - generic [ref=f1e109]: Date Of Birth
          - combobox [ref=f1e111]:
          ...
          - combobox [ref=f1e115]:
            ...
            - option "31"
        - generic [ref=f1e116]:
          - generic [ref=f1e117]: Password
          - textbox [ref=f1e119]
        - generic [ref=f1e120]:
          - generic [ref=f1e121]: Confirm Password
          - textbox [ref=f1e123]
        - generic [ref=f1e124]:
          - button "Submit" [ref=f1e125] [cursor=pointer]
          - button "Refresh" [ref=f1e126] [cursor=pointer]
      - generic [ref=f1e127]:
        - generic [ref=f1e128]: Photo
        - button "Choose File" [ref=f1e132]
  - contentinfo [ref=f1e133]:
    - generic [ref=f1e135]:
      - generic [ref=f1e136]:
        - text: "\"@ 2016\""
        - link "Automation Testing" [ref=f1e137] [cursor=pointer]:
          - /url: "#"
...
> 16 |     await page.getByRole('radio', {name: ' Male '}).check()
     |                                                     ^ Error: locator.check: Error: strict mode violation: getByRole('radio', { name: ' Male ' }) resolved to 2 elements:
  17 |     await page.getByRole('checkbox', {name: ' Cricket '}).check()
  18 | 
  19 |     await page.pause()
  20 | })
```