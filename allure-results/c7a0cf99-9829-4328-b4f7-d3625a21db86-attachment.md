...
- generic [active] [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Educational Resources" [ref=f1e57] [cursor=pointer]
          - link "Social Sciences" [ref=f1e62] [cursor=pointer]
          - link "Drag and drop testing" [ref=f1e67] [cursor=pointer]
          - link "Software" [ref=f1e72] [cursor=pointer]
          - link "Selenium testing course" [ref=f1e77] [cursor=pointer]
          - link "Software testing tutorials" [ref=f1e82] [cursor=pointer]
          - link "Interaction testing tools" [ref=f1e87] [cursor=pointer]
      - generic [ref=f1e93]:
        - generic [ref=f1e94]:
  ...
  - generic [ref=f1e194]:
    - link "Go to shopping options for Automation demo site" [ref=f1e199] [cursor=pointer]: Automation demo site
