...
- generic [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Selenium testing course" [ref=f1e52] [cursor=pointer]
          - link "Software testing tutorials" [ref=f1e57] [cursor=pointer]
          - link "File upload testing" [ref=f1e62] [cursor=pointer]
          - link "Automation demo site" [ref=f1e67] [cursor=pointer]
          - link "Development Tools" [ref=f1e72] [cursor=pointer]
          - link "Testing consulting services" [ref=f1e77] [cursor=pointer]
          - link "Southeast Asians & Pacific Islanders" [ref=f1e82] [cursor=pointer]
          - link "Web application testing" [ref=f1e87] [cursor=pointer]
      - generic [ref=f1e93]:
        - generic [ref=f1e94]:
  ...
  - generic [ref=f1e194]:
    - link "Go to shopping options for Datepicker testing" [ref=f1e199] [cursor=pointer]: Datepicker testing
