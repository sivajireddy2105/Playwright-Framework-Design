...
Call log:
  - waiting for getByRole('checkbox', { name: ' Cricket ' })
...
- generic [ref=f1e1]:
    ...
    - generic [ref=f1e44]:
      - insertion [ref=f1e46]:
        - generic [ref=f1e49]:
          ...
          - link "Test case generation" [ref=f1e52] [cursor=pointer]
          - link "Dictionaries & Encyclopedias" [ref=f1e57] [cursor=pointer]
          - link "Southeast Asians & Pacific Islanders" [ref=f1e62] [cursor=pointer]
          - link "Test automation tools" [ref=f1e67] [cursor=pointer]
          - link "Selenium testing course" [ref=f1e72] [cursor=pointer]
          - link "Selenium certification program" [ref=f1e77] [cursor=pointer]
          - link "Social Sciences" [ref=f1e82] [cursor=pointer]
          - link "Email & Messaging" [ref=f1e87] [cursor=pointer]
      - generic [ref=f1e93]:
        - generic [ref=f1e94]:
  ...
  - generic [ref=f1e194]:
    - link "Go to shopping options for Software testing tutorials" [ref=f1e199] [cursor=pointer]: Software testing tutorials
