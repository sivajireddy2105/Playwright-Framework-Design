...
```
Error: locator.check: Error: strict mode violation: locator('div label.checks') resolved to 3 elements:
    1) <label class="checks"> Cricket </label> aka getByText('Cricket')
    2) <label class="checks">Movies </label> aka getByText('Movies')
    ...

Call log:
  - waiting for locator('div label.checks')
...
> 21 |         await page.locator('div label.checks').check()
     |                                                ^ Error: locator.check: Error: strict mode violation: locator('div label.checks') resolved to 3 elements:
  22 |     }
  23 | 
  24 |     await page.pause()
